          ...
          <tbody>
            <tr>
              <td>
                ...
                <br />
                <br />
                <Link to="/recipies#mexican" className="picture description">
                  Mexican
                </Link>
              </td>
              <td>
                ...
                <br />
                <br />
                <Link to="/recipies#italian" className="picture description">
                  Italian
                </Link>
              </td>
            </tr>
            <tr>
              <td>
                ...
                <br />
                <br />
                <Link to="/recipies#indian" className="picture description">
                  Indian
                </Link>
              </td>
              <td>
                ...
                <br />
                <br />
                <Link to="/recipies#thai" className="picture description">
                  Thai
                </Link>
              </td>
            </tr>
            <tr>
              <td>
                ...
                <br />
                <br />
                <Link to="/recipies#seafood" className="picture description">
                  Seafood
                </Link>
              </td>
              <td>
                ...
                <br />
                <br />
                <Link to="/recipies#ramen" className="picture description">
                  Ramen
                </Link>
              </td>
            </tr>
